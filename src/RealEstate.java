...
public class RealEstate {
    ...
    private static final int PHONE_NUMBER_FIRST_DIGIT = 0;
    private static final int PHONE_NUMBER_SECOND_DIGIT = 5;
    ...
    private boolean isValidPhoneNumber(String phoneNumberToCheck) {
        ...
        if (phoneNumberToCheck.charAt(0) == PHONE_NUMBER_FIRST_DIGIT && phoneNumberToCheck.charAt(1) == PHONE_NUMBER_SECOND_DIGIT) {
